...
很高兴地宣布，我的 R 语言扩展包 `bookdownplus' (\protect\hyperlink{ref-R-bookdownplus}{Zhao 2017}) 在 CRAN 正式发布了。

bookdownplus 是对 bookdown 包 (\protect\hyperlink{ref-R-bookdown}{Xie 2016}) 的增强和简化。bookdown 就好比 Microsoft Word 或 LaTeX，可以用来写文档，而 bookdownplus 提供了很多有用的模板，可以很方便地在 bookdown 平台写期刊论文、学位论文、学术海报、化学分子式、信件、日记、日历、诗集、吉他谱等各种常用文档和书籍。这是功能上的增强（+）。
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\FunctionTok{head}\NormalTok{(airquality), }\AttributeTok{caption =} \StringTok{\textquotesingle{}空气质量数据。\textquotesingle{}}\NormalTok{,}
...
\hypertarget{ux6750ux6599ux4e0eux65b9ux6cd5}{%
\chapter{材料与方法}\label{ux6750ux6599ux4e0eux65b9ux6cd5}}

\hypertarget{ux51c6ux5907}{%
...
\hypertarget{ux751fux6210ux6a21ux677fux6587ux4ef6}{%
\section{生成模板文件}\label{ux751fux6210ux6a21ux677fux6587ux4ef6}}
...
\hypertarget{ux7f16ux8bd1ux6210ux4e66}{%
\section{编译成书}\label{ux7f16ux8bd1ux6210ux4e66}}

用 RStudio 打开 \texttt{bookdownplus.Rproj}文件，然后按 \texttt{ctrl+shift+b}，Duang！你就得到模板书 \texttt{*.pdf}了！保存在 \texttt{\_book/} 文件夹里。

\hypertarget{ux4f60ux7684ux6587ux5b57}{%
\section{你的文字}\label{ux4f60ux7684ux6587ux5b57}}

在 \texttt{index.Rmd} 和 \texttt{body.Rmd} 里写你自己的文字，享受写书的快乐吧！自古皆死，不朽者文。

\hypertarget{ux66f4ux591aux8f93ux51faux683cux5f0f}{%
\section{更多输出格式}\label{ux66f4ux591aux8f93ux51faux683cux5f0f}}

模板默认生成的书是pdf格式。`bookdownplus' 从 1.0.3 开始，可以很方便地输出更多格式，包括国内最常见的 'word'格式，网页'html'格式和电子书'epub'格式，只需运行：

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bookdownplus}\SpecialCharTok{::}\FunctionTok{bookdownplus}\NormalTok{(}\AttributeTok{template =} \StringTok{\textquotesingle{}article\textquotesingle{}}\NormalTok{, }
    \AttributeTok{more\_output =} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}html\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}word\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}epub\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{ux66f4ux591aux5efaux8bae}{%
\section{更多建议}\label{ux66f4ux591aux5efaux8bae}}
...
\hypertarget{ux5b9aux7406ux63a8ux5012}{%
\chapter{定理推倒}\label{ux5b9aux7406ux63a8ux5012}}

\raggedbottom

\hypertarget{ux5b9aux7406-a-ux7684ux63a8ux5012}{%
\section{定理 A 的推倒}\label{ux5b9aux7406-a-ux7684ux63a8ux5012}}

\flushbottom

\backmatter

\hypertarget{ux4f5cux8005ux7b80ux5386ux53caux653bux8bfbux5b66ux4f4dux671fux95f4ux53d1ux8868ux7684ux5b66ux672fux8bbaux6587ux4e0eux7814ux7a76ux6210ux679c}{%
\chapter{作者简历及攻读学位期间发表的学术论文与研究成果}\label{ux4f5cux8005ux7b80ux5386ux53caux653bux8bfbux5b66ux4f4dux671fux95f4ux53d1ux8868ux7684ux5b66ux672fux8bbaux6587ux4e0eux7814ux7a76ux6210ux679c}}
...
\leavevmode\vadjust pre{\hypertarget{ref-R-bookdownplus}{}}%
